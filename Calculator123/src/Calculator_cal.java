...
public class Calculator_cal extends Frame  
{  
...
///////////////////////////  
Calculator_cal(String frameText)//constructor  
{  
super(frameText);  
...
{  
new Calculator_cal("Calculator - JavaTpoint");  
}  
}  
...
//////////////////////////////////////////  
MyDigitButton(int x,int y, int width,int height,String cap, Calculator_cal clc)  
{  
super(cap);  
...
MyOperatorButton(int x,int y, int width,int height,String cap, Calculator_cal clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
...
if(opText.equals("1/x"))  
    ...
    try  
        ...
        cl.displayLabel.setText(Calculator_cal.getFormattedText(tempd));}  
...
cl.displayLabel.setText(Calculator_cal.getFormattedText(temp));  
//cl.number=temp;  
}//actionPerformed  
}//class  
...
/////////////////////////////////  
MyMemoryButton(int x,int y, int width,int height,String cap, Calculator_cal clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
...
case 'R':   
    cl.displayLabel.setText(Calculator_cal.getFormattedText(cl.memValue));break;  
case 'S':  
    cl.memValue=0.0;  
case '+':   
...
MySpecialButton(int x,int y, int width,int height,String cap, Calculator_cal clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
